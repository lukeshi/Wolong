...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    cell.textLabel.text = [NSString stringWithFormat: @"联系人%d", (int)indexPath.row+1];
    cell.detailTextLabel.text = @"email.address@domain.com";
    
    return cell;
}

#define HEADER_HEIGHT 24.0
